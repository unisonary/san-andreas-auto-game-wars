...
public class AdsDisplayCheck : MonoBehaviour
{
	...
	public static AdsDisplayCheck instance;
	...
	public void ShowAdmobInterstitial()
	{
		...
		{
			AdManager.instance.ShowToast("Admob ad not ready to display");
		}
	}
	...
	public void ShowAdmobRewardBasedVideo()
	{
		...
		{
			AdManager.instance.ShowToast("---------Admob Video not ready to display");
	...
	public void ShowIronSourceInterstitial()
	{
		...
		{
			AdManager.instance.ShowToast("Ironsource ad not ready to display");
	...
	public void ShowIronSourceRewardVideo()
	{
		...
		{
			AdManager.instance.ShowToast("IronSource Video not ready to display");
