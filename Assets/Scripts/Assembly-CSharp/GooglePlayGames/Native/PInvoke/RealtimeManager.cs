...
namespace GooglePlayGames.Native.PInvoke
{
	internal class RealtimeManager
	{
		...
		{
			RealTimeMultiplayerManager.RealTimeMultiplayerManager_SendUnreliableMessage(mGameServices.AsHandle(), room.AsPointer(), Enumerable.ToArray(Enumerable.Select(recipients, (MultiplayerParticipant r) => r.AsPointer())), new UIntPtr((ulong)Enumerable.LongCount(recipients)), data, PInvokeUtilities.ArrayToSizeT(data));
		}
